...
Antes de assinar e atribuir licenças aos usuários para o Power BI for US Government, é preciso se inscrever em um plano do Office 365 Government. Caso sua organização já tenha um plano do Office 365 Government, passe para [Comprar uma assinatura do Power BI Pro para clientes do governo](#buy-a-power-bi-pro-subscription-for-government-customers).

### <a name="enroll-in-an-office-365-government-plan"></a>Inscrever-se em um plano do Office 365 Government

Caso seja um novo cliente, você precisa validar a qualificação da sua organização antes de se inscrever em um plano do Office 365 Government.  Comece preenchendo o [formulário de validação de qualificação do Office 365 para o Governo](https://www.microsoft.com/microsoft-365/government/eligibility-validation). Para garantir que você está selecionando o plano adequado para sua organização, confira as [descrições do serviço do Office 365 para o Governo norte-americano](https://docs.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/office-365-us-government).
...
O Office 365 fornece diversos ambientes para que as agências governamentais atendam aos vários requisitos de conformidade. Para obter mais informações sobre cada ambiente, confira:
