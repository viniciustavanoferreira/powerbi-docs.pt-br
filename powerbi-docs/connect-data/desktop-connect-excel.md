...
![Captura de tela da opção do Excel.](media/desktop-connect-excel/connect_to_excel_1.png)

Selecione a pasta de trabalho na caixa de diálogo **Abrir** exibida.
![Captura de tela da caixa de diálogo Abrir.](media/desktop-connect-excel/connect_to_excel_2.png)
...
![Captura de tela da janela Navegador.](media/desktop-connect-excel/connect_to_excel_3.png)
...
![Captura de tela da janela Carregar.](media/desktop-connect-excel/connect_to_excel_4.png)
...
![Captura de tela do painel Campos.](media/desktop-connect-excel/connect_to_excel_5.png)
