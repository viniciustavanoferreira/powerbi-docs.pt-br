...
**Nova experiência de filtro necessária** – você deve ter a [nova experiência de filtro](../create-reports/power-bi-report-filter.md) habilitada para seu relatório. Veja como você pode habilitá-lo para seu relatório no Power BI Desktop:
