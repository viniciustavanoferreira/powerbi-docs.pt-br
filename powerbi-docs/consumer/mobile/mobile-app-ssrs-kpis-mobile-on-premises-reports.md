...
6. Agora você vê o servidor no painel de navegação – neste exemplo, chamado "servidor de relatório do power bi."
...
1. Na parte inferior do painel de navegação, toque em **Configurações**.
