...
1. Alterne para [Exibição de Dados](../connect-data/desktop-data-view.md) selecionando o ícone de tabela ![ícone de tabela](media/sample-tutorial-connect-to-the-samples/power-bi-data-icon.png).
...
1. Alterne para a [exibição de Relacionamentos](../transform-model/desktop-relationship-view.md) selecionando o ícone a seguir: ![Ícone de exibição de relacionamento](media/sample-tutorial-connect-to-the-samples/power-bi-desktop-relationship-icon.png).
