...
* Se sua pasta de trabalho tiver um modelo de dados do Power Pivot, você poderá fazer ainda mais otimizações. Leia mais sobre [Desmistificando o P e R do Power BI, parte 2](https://powerbi.microsoft.com/blog/demystifying-power-bi-q-amp-a-part-2/) da nossa equipe interna de especialistas em idioma natural.
