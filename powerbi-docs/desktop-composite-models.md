...
No momento, há suporte para [atualização incremental](service-premium-incremental-refresh.md) somente para modelos compostos conectando-se a fontes de dados SQL, Oracle e Teradata.
