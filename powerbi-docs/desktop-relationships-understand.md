...
ms.locfileid: "76309103"
---
# <a name="create-model-relationships-in-power-bi-desktop"></a>Criar relações de modelo no Power BI Desktop
...
- Vídeo: [Regras sobre as relações do Power BI](https://youtu.be/78d6mwR8GtA)
