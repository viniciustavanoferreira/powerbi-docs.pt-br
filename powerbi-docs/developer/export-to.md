...
Um trabalho que exceda o número de solicitações simultâneas não será concluído. Por exemplo, se você exportar três páginas em um SKU A1, o primeiro trabalho será executado, e os dois posteriores aguardarão até os próximos dois ciclos de execução.
...
* O relatório que você está exportando deve residir em uma capacidade.
* O conjunto de dados do relatório que você está exportando deve residir em uma capacidade.
