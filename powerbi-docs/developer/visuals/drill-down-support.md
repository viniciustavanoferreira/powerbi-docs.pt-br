---
title: Adicionar suporte a busca detalhada
description: Este artigo descreve como adicionar suporte para drill-down aos visuais do Power BI
author: asander
ms.author: asander
manager: rkarlin
ms.reviewer: sranins
...
## <a name="enable-drill-down-support-in-the-visual"></a>Habilitar o suporte para drill-down no visual

Para dar suporte ao drill-down em seu visual, adicione um novo campo a `capabilities.json` chamado "drill-Down", que tem uma propriedade:
...
Depois de você adicionar a função ao drill-down, os usuários podem arrastar vários campos para a função de dados.
...
## <a name="create-the-visual-with-drill-down-support"></a>Criar o visual com suporte para drill-down
...
para criar um visual de exemplo padrão. E aplique o exemplo acima de `capabilities.json` ao visual recém-criado.
...
Atualize o método `update` do visual para criar `button`s:
...
Prepare dados de exemplo para testar o visual com mapeamentos de exibição de dados de matriz:
...
Aplique o seguinte mapeamento de DataView ao visual:
...
Crie duas propriedades para duas `div`s de elementos de linhas e colunas:
...
Gere as seleções para pontos de extremidade.
