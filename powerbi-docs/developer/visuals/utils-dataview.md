...
ms.locfileid: "75308653"
---
# <a name="dataviewutils"></a>DataViewUtils

O `DataViewUtils` é um conjunto de funções e classes para simplificar a análise do objeto DataView para visuais personalizados do Power BI
...
Essa função retorna um valor do objeto pelo nome da propriedade.
