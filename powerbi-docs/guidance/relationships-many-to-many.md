...
- Quando não for apropriado ter valores de ID ausentes, defina a propriedade **Is Nullable** de colunas de ID como TRUE. A atualização de dados falhará ao se obter os valores ausentes
