...
ms.locfileid: "81268525"
---
# <a name="administrators-learning-catalog"></a>Catálogo de aprendizagem para administradores

Precisa manter os sistemas e dados fluindo, provisionados e protegidos 24 horas por dia?
...
## <a name="deploy"></a>Implantar<a name="deploy"></a>
| Conteúdo | Descrição  | Formatar | Tamanho |
|-------------------------------------------------------------------------------------|---------------------------------------------------------------------|--------|--------|
