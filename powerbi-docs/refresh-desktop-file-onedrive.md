...
> [!NOTE]
> Há suporte para arquivos importados no OneDrive, mas não há suporte para conjuntos de dados conectados dinâmicos no OneDrive como um cenário de atualização do OneDrive.
