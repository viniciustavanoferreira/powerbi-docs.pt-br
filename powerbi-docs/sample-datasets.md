...
- E ainda um **[pasta de trabalho de dados financeiros de exemplo](sample-financial-download.md)** , uma tabela simples em um arquivo do Excel disponível para download. Ela contém dados anônimos com produtos fictícios, com vendas divididas por segmentos e países. Serve de fonte de dados básica útil para um relatório do Power BI.
