...
## <a name="two-ways-to-get-started"></a>Duas maneiras de começar
Há duas maneiras diferentes de explorar seus conjuntos do Power BI no Excel – se você estiver começando do Power BI, seguirá as etapas descritas neste documento.  Agora também há a capacidade de os usuários com certas SKUs do Office acessarem seus conjuntos de dados diretamente da experiência Obter Dados em uma pasta de trabalho do Excel.  Eles podem navegar pelos conjuntos de dados aos quais eles têm acesso, ver se os conjuntos de dados são certificados ou promovidos e se as etiquetas de proteção de dados foram aplicadas.  Para saber mais sobre essa experiência, confira [Criar uma tabela dinâmica de conjuntos de dados do Power BI](https://support.office.com/article/31444a04-9c38-4dd7-9a45-22848c666884) na documentação do Excel.
...
* Usuários convidados não podem usar **Analisar no Excel** para conjuntos de dados enviados de outro locatário. 
...
## <a name="get-started-with-analyze-in-excel-in-power-bi"></a>Introdução ao recurso Analisar no Excel no Power BI
...
Você terá uma oportunidade para entrar novamente, quando você poderá entrar com a conta do Power BI que tem acesso ao conjunto de dados acessado pelo recurso Analisar no Excel. Você também pode selecionar seu nome na faixa de opções superior no Excel, que identifica a conta com a qual você está conectado no momento. Saia e entre com uma conta diferente.
