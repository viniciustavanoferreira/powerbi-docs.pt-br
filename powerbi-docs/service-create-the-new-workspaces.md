...
Pronto para migrar seu workspace clássico? Confira [Atualizar workspaces clássicos para os novos workspaces no Power BI](designer/service-upgrade-workspaces.md) para obter detalhes.
