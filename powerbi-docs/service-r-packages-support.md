...
Os pacotes de R com suporte para o **serviço do Power BI** são encontrados na seção a seguir, intitulada **Pacotes com suporte**. Se você quiser solicitar o suporte de um pacote de R não encontrado nessa lista, envie sua solicitação para [Ideias do Power BI](https://ideas.powerbi.com).
